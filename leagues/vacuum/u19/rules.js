  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '🔋 باتری', b: '<b>battery</b> از ۱۰۰ شروع می‌شود؛ رانندگی با تمام سرعت حدود <b>۱٫۷٪ در ثانیه</b> می‌سوزاند (۱۰۰٪ ≈ ۶۰ ثانیه). در <b>صفر</b>، ربات خاموش نمی‌شود ولی فقط <b>می‌خزد (۱۵٪ سرعت)</b> — می‌تواند خودش را تا پد بکشاند، اما خزیدن در طول خانه بیشترِ وقتِ باقی‌مانده را می‌خورد. داور نجاتت نمی‌دهد؛ این قانونِ خودِ بازی است.' },
        ...
        { h: '🗑 مخزن خاک — فعلاً خاموش', b: '<b>در مسابقه‌های امسال ایستگاه تخلیه وجود ندارد</b> و مخزن هرگز پر نمی‌شود؛ این بند برای وقتی است که دوباره روشن شود. در مسابقه‌ی تک‌نفره مخزن هر <b>۳۰ کاشی</b> پر می‌شود و رباتِ پُر هیچ کاشی‌ای نمی‌گیرد تا خودش را به <b>ایستگاه تخلیه</b> برساند (dumpx و dumpy — دستگاهی جدا از پد شارژ). دو مأموریت، دو سفر. در بازی دو نفره مخزن پر نمی‌شود و رسیدن به ایستگاه یک بار <b>+۵</b> دارد.' },
        { h: '🐈 مثل U14', b: 'گربه و سگ، فرش‌ها، FINAL mode و جریمه‌ی جابه‌جایی <b>۲ کاشی</b> (زیر ۱۰ کاشی، بدون جریمه) — همه مثل U14 برقرارند.' },
        ...
        { h: '⚖️ Rules at a glance (EN)', b: 'Every floor tile you drive over turns your colour and scores one point; LAST TOUCH owns the tile. Stuck for 10 s in one small circle → you are relocated and it costs 2 tiles — nothing at all while you own fewer than 10. Water (U19 only): −10% battery per entry, never tiles; FS and U14 have no water at all. Green rug: half speed, no points. Purple / orange / cyan rugs: doorway markers — no points, full speed. A draw stands as a draw — there is no overtime, and it is worth a point each in the table; a drawn knockout game is replayed. The full referee book with every number is <b>RULES.md</b> beside the game.' },
    ...
    rules: { pets: true, wet: true, waterBattery: 10, penalty: 2, battery: true, dump: false },
    create: mk,
  });
