  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '💧🐈 مثل U14', b: 'گربه و سگ، کف خیس (−۲ کاشی به‌ازای هر ورود)، فرش‌ها، FINAL mode و جریمه‌ی جابه‌جایی <b>−۵ کاشی</b> — همه مثل U14 برقرارند.' },
