  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '⚖️ Rules at a glance (EN)', b: 'Every floor tile you drive over turns your colour and scores one point; LAST TOUCH owns the tile. Stuck for 15 s in one small circle → the referee relocates you at a penalty. Water (U19 only): −10% battery per entry, never tiles; FS and U14 have no water at all. Green rug: half speed, no points. Purple / orange / cyan rugs: doorway markers — no points, full speed. Draw → +10 s then +5 s steps up to 35 s of overtime. The full referee book with every number is <b>RULES.md</b> beside the game.' },
