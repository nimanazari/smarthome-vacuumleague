  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '⚖️ جریمه‌ها', b: 'رباتی که <b>۱۵ ثانیه</b> در یک دایره‌ی کوچک گیر کند، داور جابه‌جایش می‌کند (به یک کاشی آزادِ تصادفی در هر جای خانه، دستِ‌کم ۶ کاشی آن‌طرف‌تر) و جریمه می‌شود: <b>بار اول −۵، بار دوم −۱۰، از بار سوم به بعد −۱۲ کاشی</b> — هر چه بیشتر جابه‌جا شوی، گران‌تر. داور با دکمه‌ی منو هم می‌تواند جابه‌جا کند، با همان جریمه.' },
        ...
        { h: '⚖️ Rules at a glance (EN)', b: 'Every floor tile you drive over turns your colour and scores one point; LAST TOUCH owns the tile. Stuck for 15 s in one small circle → the referee relocates you at a penalty. No wet floor in FS or U14; the water is U19 only, and it costs battery, never tiles. Green rug: half speed, no points. Purple / orange / cyan rugs: doorway markers — no points, full speed. Draw → +10 s then +5 s steps up to 35 s of overtime. The full referee book with every number is <b>RULES.md</b> beside the game.' },
