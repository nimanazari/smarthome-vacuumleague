  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '⏱ زمان', b: 'مسابقه <b>۱۸۰ ثانیه (۳ دقیقه)</b> است و همین‌جا تمام می‌شود. <b>وقت اضافه نداریم</b>: اگر مساوی شد، مساوی می‌ماند و در جدول به هر دو تیم <b>یک امتیاز</b> می‌رسد. فقط در بازی حذفی، بازی <b>دوباره اجرا</b> می‌شود.' },
        ...
        { h: '⚖️ جریمه‌ها', b: 'رباتی که <b>۱۰ ثانیه</b> در یک دایره‌ی کوچک پیشروی نکند، خودکار جابه‌جا می‌شود (کاشی آزادِ تصادفی، دست‌کم ۶ کاشی آن‌طرف‌تر) و <b>۲ کاشی</b> جریمه می‌دهد. جابه‌جایی دستیِ داور هم همین هزینه را دارد. <b>زیر ۱۰ کاشی جریمه نمی‌شوی</b> — تازه‌کار با یک گیرکردنِ زودهنگام ته جدول نمی‌ماند.' },
        ...
        { h: '⚖️ Rules at a glance (EN)', b: 'Every floor tile you drive over turns your colour and scores one point; LAST TOUCH owns the tile. Stuck for 10 s in one small circle → you are relocated and it costs 2 tiles — nothing at all while you own fewer than 10. No wet floor in FS or U14; the water is U19 only, and it costs battery, never tiles. Green rug: half speed, no points. Purple / orange / cyan rugs: doorway markers — no points, full speed. A draw stands as a draw — there is no overtime, and it is worth a point each in the table; a drawn knockout game is replayed. The full referee book with every number is <b>RULES.md</b> beside the game.' },
