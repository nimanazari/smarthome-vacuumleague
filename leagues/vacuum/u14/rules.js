  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '⚖️ جریمه‌ها', b: '۱۰ ثانیه گیرکردن در یک دایره‌ی کوچک = جابه‌جایی توسط داور (چند کاشی آن‌طرف‌تر) با جریمه‌ی پله‌ای: <b>بار اول −۵، بار دوم −۱۰، از بار سوم −۱۲ کاشی</b>. جابه‌جایی دستی داور هم همان جریمه را دارد. تساوی؟ +۱۰ ثانیه، بعد +۵های پیاپی تا سقف ۳۵ ثانیه.' },
