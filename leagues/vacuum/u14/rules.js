...
(function (root) {
  ...
  L.register({
    ...
    rules: { pets: true, wet: false, penalty: [5, 10, 12], battery: false },
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '⚖️ جریمه‌ها', b: '۱۵ ثانیه گیرکردن در یک دایره‌ی کوچک = جابه‌جایی توسط داور (به یک کاشی آزادِ تصادفی در هر جای خانه، دستِ‌کم ۶ کاشی آن‌طرف‌تر) با جریمه‌ی پله‌ای: <b>بار اول −۵، بار دوم −۱۰، از بار سوم −۱۲ کاشی</b>. جابه‌جایی دستی داور هم همان جریمه را دارد. تساوی؟ +۱۰ ثانیه، بعد +۵های پیاپی تا سقف ۳۵ ثانیه.' },
        ...
        { h: '⚖️ Rules at a glance (EN)', b: 'Every floor tile you drive over turns your colour and scores one point; LAST TOUCH owns the tile. Stuck for 15 s in one small circle → the referee relocates you at a penalty. Green rug: half speed, no points. Purple / orange / cyan rugs: doorway markers — no points, full speed. Draw → +10 s then +5 s steps up to 35 s of overtime. The full referee book with every number is <b>RULES.md</b> beside the game.' },
