...
(function (root) {
  ...
  L.register({
    ...
    group: 'vacuum',
    // the 22x22 ROOMS house. The WET RUGS are filtered out: with `wet` off
    // a puddle would still be painted on the floor while doing nothing at
    // all, and there would be nothing on screen to explain why. Taking
    // them off the map is what makes "no wet floor" literally true.
    map: Object.assign({}, GROWN_ROOMS, {
    ...
    blurb: {
      en: 'The full house: a cat, a dog, rugs — and a rival who can steal every tile you just cleaned.',
      fa: 'خانه‌ی کامل: گربه، سگ، فرش — و حریفی که می‌تواند هر کاشی‌ای را که تازه تمیز کرده‌ای بدزدد.',
    },
    bullets: [
      { en: 'The cat and the dog wander around as moving obstacles', fa: 'گربه و سگ به‌عنوان مانع متحرک در خانه می‌چرخند' },
      { en: 'Rugs: the green one halves your speed and scores nothing', fa: 'فرش سبز: نصف سرعت و صفر امتیاز' },
    ...
    // no wet floor anywhere in the league any more — see the map above
    rules: { pets: true, wet: false, penalty: 2, battery: false },
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '⚖️ جریمه‌ها', b: 'رباتی که <b>۱۰ ثانیه</b> در یک دایره‌ی کوچک پیشروی نکند، خودکار جابه‌جا می‌شود (کاشی آزادِ تصادفی، دست‌کم ۶ کاشی آن‌طرف‌تر) و <b>۲ کاشی</b> جریمه می‌دهد. جابه‌جایی دستیِ داور هم همین هزینه را دارد. <b>زیر ۱۰ کاشی جریمه نمی‌شوی</b> — تازه‌کار با یک گیرکردنِ زودهنگام ته جدول نمی‌ماند. مسابقه <b>۱۸۰ ثانیه (۳ دقیقه)</b> است و همین‌جا تمام می‌شود. <b>وقت اضافه نداریم</b>: اگر مساوی شد، مساوی می‌ماند و در جدول به هر دو تیم <b>یک امتیاز</b> می‌رسد. فقط در بازی حذفی، بازی <b>دوباره اجرا</b> می‌شود.' },
        ...
        { h: '⚖️ Rules at a glance (EN)', b: 'Every floor tile you drive over turns your colour and scores one point; LAST TOUCH owns the tile. Stuck for 10 s in one small circle → you are relocated and it costs 2 tiles — nothing at all while you own fewer than 10. Green rug: half speed, no points. Purple / orange / cyan rugs: doorway markers — no points, full speed. A draw stands as a draw — there is no overtime, and it is worth a point each in the table; a drawn knockout game is replayed. The full referee book with every number is <b>RULES.md</b> beside the game.' },
