  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '🔋 باتری و شارژ', b: 'همان قانون U19: <b>battery</b> از ۱۰۰ شروع می‌شود و رانندگی با تمام سرعت حدود <b>۱٫۷٪ در ثانیه</b> می‌سوزاند. ایستگاه شارژ جای ثابتی دارد (<b>dockx</b>، <b>docky</b>) و روی پد <b>+۲۵٪ در ثانیه</b> می‌گیری. در صفر، ربات فقط می‌خزد (۱۵٪ سرعت) — هنوز می‌تواند خودش را به پد برساند، ولی مسابقه‌ات تمام است.' },
