  ...
  L.register({
    ...
    guide: {
      ...
      sections: [
        ...
        { h: '⏱ زمان را روز مسابقه می‌گوییم', b: 'سوپرتیم زمانِ ثابت ندارد — مأموریت و طول مسابقه همان روز اعلام می‌شود. عددِ پیش‌فرضِ روی صفحه فقط یک نقطه‌ی شروع است و داور آن را عوض می‌کند.' },
        ...
        { h: '🐈 بقیه‌ی قوانین', b: 'گربه و سگ مثل U14 در خانه می‌چرخند، <b>آخرین لمس مالک کاشی است</b> (کاشی حریف را می‌شود پس گرفت)، و جریمه‌ی هر جابه‌جایی <b>۲ کاشی</b> است (زیر ۱۰ کاشی، بدون جریمه).' },
